...
Regardless of what requirement, Substrate framework provides programmable primitives\footnote{Off-chain workers} to effectively support both and be able to perform fork-less\footnote{WASM runtime} upgrades in case for example base protocol will have some breaking changes.

// Perform rebase on satellite chain and propagate to the upstream.
