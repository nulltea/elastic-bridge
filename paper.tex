...
\author{Timothy Yalugin}

\begin{document}
\maketitle

\begin{abstract}
Emerging applications of blockchain technology indicate an ongoing trend for market diversification. Once the idea of sovereignty-preserving application-specific chains became feasible to implement, it quickly displace a single chain-maximalism dogma. Effectively improved on scalability, we encountered new challenges with cross-chain interoperability.

We have then seen cross-chain bridges --- protocols that allow two (or more) exogenous chains to share state, has make their own way from centralized PoA, trusted federations, to truly trust-less decentralized Relayed SPV solutions like Cosmos IBC.
